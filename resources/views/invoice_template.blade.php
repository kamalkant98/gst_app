...
<body>
    ...
    <table border="1" style="  border-collapse: collapse; " >
        ...
        <tr>
            ...
            <td rowspan="2" colspan="7" style="padding: 0px;">
        ...
        <tr style="height: 25px;">
            <td colspan="3"  width="50%" style="text-align: center;">Particulars</td>
        ...
        @for ($i = 0; $i < $count; $i++)
            @if(isset($data['plans'][$i]['name']))
                <tr class= "jk">
                    <td colspan="3"  width="60%" style="height: 46px;padding-left: 30px; border-top: none;border-bottom: none;">{{$data['plans'][$i]['name']}}</td>
            ...
            @else
                <tr class= "jk">
                    <td colspan="3"  width="60%" style="height: 46px;padding-left: 30px; border-top: none;border-bottom: none;"></td>
        ...
        @if (isset($data['lessAmount']) && $data['lessAmount'] > 0)
            <tr style="height: 25px; border:non;">
                <td  colspan="3" width="60%" style="text-align: right;">Coupon Discount / Round OFF</td>
                <td width="20%" colspan="1"></td>
                <td width="20%" colspan="3"><strong>{{$data['lessAmount']}}</strong></td>
            </tr>
        @endif
        <tr style="height: 25px;">
            <td  colspan="3" width="60%" style="text-align: right;"><b>Cgst</b></td>
            <td width="20%" colspan="1"></td>
            <td width="20%" colspan="3"><strong>{{$data['cgst']}}</strong></td>
        </tr>
        <tr style="height: 25px;">
            <td  colspan="3" width="60%" style="text-align: right;"><b>Sgst</b></td>
            <td width="20%" colspan="1"></td>
            <td width="20%" colspan="3"><strong>{{$data['sgst']}}</strong></td>
        </tr>
        <tr style="height: 25px;">
            <td  colspan="3" width="60%" style="text-align: right;">Total</td>
            <td width="20%" colspan="1"></td>
        ...
        <tr style="height: 50px;">
            ...
            <td colspan="2" style="text-align: right;border-left: none;border-right: none; padding: 5px;">E. & O.E</td>
        </tr>
        <tr style="">
            ...
            <td rowspan="2" style="font-size: 12px;">Total Tax Amount</td>
        ...
        <tr style="">
            ...
            <td> <strong>{{$data['totalTax']}}</strong></td>
        </tr>
        <tr>
            <td colspan="7" style="padding: 5px;">
        ...
        <tr style="border-bottom:none;">
            <td colspan="7" style="text-align: center;">This is a Computer Generated Invoice</td>
        </tr>
    </table>
</body>
</html>

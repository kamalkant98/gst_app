    ...
    <script>
        ...
        $(document).ready(() => {
            ...
            $('#multi-select').on('change', function () {
                ...
                //     document.querySelector('.other_query_message_box').style.display = 'block';
                //     document.querySelector('#other_query_message').classList.remove('hide-input');
                //     document.querySelector('#other_query_message').classList.add('show-input');
                // }else{
                //     document.querySelector('.other_query_message_box').style.display = 'none';
                //     document.querySelector('#other_query_message').classList.remove('show-input');
                //     document.querySelector('#other_query_message').classList.add('hide-input');
                // }
            });

            ...
            <div class="col-lg-6 col-md-8 col-offset-2 col-sm-12 col-sm-offset-2">
                ...
                <form id="gst_queries" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 hidden-box-2 composition">
                        ...
                        <select class="form-control" id="plan_name" name="plan_name" requiredInput>
                    ...
                    <div class="mb-3 hidden-box-2 regular">
                        ...
                        <select class="form-control" id="return_filling_frequency" name="return_filling_frequency" requiredInput>
                            <option  value="">select value</option>
                    ...
                    <div class="mb-3 hidden-box-2 regular">
                        ...
                        <select class="form-control" id="service_type" name="service_type" requiredInput>
                            <option  value="">select value</option>
